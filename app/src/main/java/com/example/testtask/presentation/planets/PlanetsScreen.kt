...
fun PlanetsScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.planets_title)) },
                actions = {
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.planets_search_label)) },
                singleLine = true,
                ...
                when {
                    ...
                    uiState.items.isEmpty() -> {
                        Column(
                            ...
                            Text(
                                stringResource(R.string.planets_empty),
                        ...
                        LazyColumn(
                            ...
                            items(uiState.items, key = { it.id }) { planet ->
...
private fun PlanetCard(
    ...
    StarWarsCard(onClick = { onClick(planet.id) }) {
        Text(
            planet.name,
