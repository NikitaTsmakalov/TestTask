    ...
    Scaffold(
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                OfflineBanner(text = bannerText.orEmpty())
            }
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.characters_search_label)) },
                singleLine = true,
                ...
                when {
                    ...
                    uiState.items.isEmpty() -> {
                        ...
                        LazyColumn(
                            ...
                            items(uiState.items, key = { it.id }) { character ->
...
private fun CharacterCard(
    ...
    StarWarsCard(onClick = { onClick(character.id) }) {
        Text(
            character.name,
